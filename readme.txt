...
BAPS git repo is located on urybsod, at /home/git/baps3.git
...
Unknown. You probably won't have to do this.
...
If you spot any bugs or glitches in BAPS, please report it to our bug tracker:
    http://copperbox.york.ac.uk
or if you don't have access, email:
    XXX
...
that with us either via the bug tracker or email.



4.2 Obtaining the source
------------------------
The BAPS source is available in a git repository on urybsod. Assuming you have
access, you can do an anonymous checkout by:
    git clone ssh://urybsod.york.ac.uk/home/git/baps3.git
...
BAPS using cmake. The following targets are available:
- ??? XXX
...
BAPS is created by the following people (in reverse alphabetical order):

* Lord Aro (Charles Pigott)



Contact: XXX or on irc.freenode.net/#ury
